...
public class retrouploader extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.retrouploader);

        VolleySingleton volleySingleton = new VolleySingleton(retrouploader.this);
    ...
    void showDialog() {
        new MaterialDialog.Builder(retrouploader.this).title("Choose file")
                .items(CHOOSE_FILE)
    ...
    void setView(int type, Uri uri) {
        mUpload.setVisibility(Button.VISIBLE);
        if (mFile.size() == 3) {
            Toast.makeText(retrouploader.this, "3 photos already selected", Toast.LENGTH_SHORT).show();
            //mAdd.setText("Delete");
            return ;
        }
